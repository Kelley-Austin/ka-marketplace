...
```
bash <(curl -fsSL https://raw.githubusercontent.com/Kelley-Austin/ka-marketplace/main/install.sh)
```
...
"source": {
  "source": "github",
  "repo": "Kelley-Austin/ka-sfskills",
  "sha": "abc123..."
}
```
...
```json
{
  ...
  "version": "0.1.0",
  "description": "…",
  "source": { "source": "github", "repo": "Kelley-Austin/my-new-plugin" }
}
```
